...
整理规则：
- 群里我发视频后，马上把视频同步到文档；只有我或指定项目 owner 发的视频算版本视频。
- 策划、同事或其他成员发的视频默认是参考视频，不要创建版本区块，也不要影响后续反馈归属。
- 策划反馈不一定马上出现，视频区块可以先空着。
- 正式策划反馈来自策划本人，或我明确写了“反馈整理 / 策划反馈 / 线下反馈 / 面聊反馈 / 制作会反馈”的消息。
- 如果同一个版本同时有策划/同事反馈和我发的“反馈整理 / 整理反馈”，文档最终以我的整理稿为准；我后续发的“反馈补充 / 补充反馈”继续接在整理稿后面编号显示；没有我的整理稿时，才展示策划/同事反馈。
- 如果我发“制作会反馈”，请把对应版本标记为制作会展示版本：标题加 `🚩` 和 `（制作会）`，本版定位框改成橙色，`策划反馈：` 改成 `制作会反馈：`。
- 普通讨论、提问、确认、闲聊不要写进文档。
