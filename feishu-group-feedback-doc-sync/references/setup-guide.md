...
- `version_video_people`：哪些姓名或 `open_id` 发的视频才算版本视频，通常至少包含用户本人。
...
- “策划或同事发的视频默认按参考视频处理，不会新建版本，也不会改变后续反馈归属。”
- “策划本人或你整理的正式策划反馈，会写到 `策划反馈` 下。”
- “如果你发了 `反馈整理`，同一版文档会优先显示你的整理稿；你后续发的 `反馈补充` 会继续接在整理稿后面；没有整理稿时才显示策划/同事零散反馈。”
- “如果你发 `制作会反馈`，对应版本会自动改成制作会展示样式，标题加 `（制作会）`，定位框变成橙色，反馈标题改为 `制作会反馈`。”
